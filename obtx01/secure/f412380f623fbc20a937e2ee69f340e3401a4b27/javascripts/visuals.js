    ...
    pubnub.subscribe({ channels: ['obtx01_in', 'obtx01_out', 
                                  'obtx01cam_in','obtx01cam_out', 
                                  'obtx01plate_in', 'obtx01plate_out',
                                  'obtx01AS7262_in','obtx01AS7262_out',
    ...
    pubnub.addListener({
        ...
        message: function (m) {
            ...
            if ( channelName ==='obtx01cam_out') {

                //console.log(m.message);
                parseInformationfromCamera(m)
            }

            if (channelName ==='obtx01plate_out') 
            {
            ...
            if (channelName ==='obtx01AS7262_out') 
            {
                  //console.log(m.message);
