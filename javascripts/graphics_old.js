...
ajax.open('GET', 'images/mds_wheel.svg', true)
ajax.send()

 

ajax.onload = function(e) {
	mdsWheelRef = draw.svg(ajax.responseText)
	mdsWheelRef.rotate(90)  
	}

//var newsvg = loadRawSVG('images/mds_wheel.svg')
//draw.svg( newsvg )
