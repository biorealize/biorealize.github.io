    ...
    pubnub.subscribe({ channels: ['noma01a_in', 'noma01a_out', 
                                  'noma01a_cam_in','noma01a_cam_out', 
                                  'noma01a_plate_in', 'noma01a_plate_out',
                                  'noma01a_AS7262_in','noma01a_AS7262_out',
    ...
    pubnub.addListener({
        ...
        message: function (m) {
            ...
            if ( channelName ==='noma01a_cam_out') {

                //console.log(m.message);
                parseInformationfromCamera(m)
            }

            if (channelName ==='noma01a_plate_out') 
            {
            ...
            if (channelName ==='noma01a_AS7262_out') 
            {
                  //console.log(m.message);
