    ...
    pubnub.subscribe({ channels: ['pratt01a_in', 'pratt01a_out', 
                                  'pratt01a_cam_in','pratt01a_cam_out', 
                                  'pratt01a_plate_in', 'pratt01a_plate_out',
                                  'pratt01a_AS7262_in','pratt01a_AS7262_out',
    ...
    pubnub.addListener({
        ...
        message: function (m) {
            ...
            if ( channelName ==='pratt01a_cam_out') {

                //console.log(m.message);
                parseInformationfromCamera(m)
            }

            if (channelName ==='pratt01a_plate_out') 
            {
            ...
            if (channelName ==='pratt01a_AS7262_out') 
            {
                  //console.log(m.message);
