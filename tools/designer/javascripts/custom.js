...
function collectExperimentData(){
		...
		*/
		...
		if (document.getElementById('media_type_solid').checked == true){
			...
			if (plateType.options[plateType.selectedIndex].value == 'petridish'){
				var table = document.getElementById("petridish_table");
			}

			else if (plateType.options[plateType.selectedIndex].value == 'plate_6_well'){
