    ...
    pubnub.subscribe({ channels: ['rca02a_in', 'rca02a_out', 
                                  'rca02a_cam_in','rca02a_cam_out', 
                                  'rca02a_plate_in', 'rca02a_plate_out',
                                  'rca02a_AS7262_in','rca02a_AS7262_out',
    ...
    pubnub.addListener({
        ...
        message: function (m) {
            ...
            if ( channelName ==='rca02a_cam_out') {

                //console.log(m.message);
                parseInformationfromCamera(m)
            }

            if (channelName ==='rca02a_plate_out') 
            {
            ...
            if (channelName ==='rca02a_AS7262_out') 
            {
                  //console.log(m.message);
